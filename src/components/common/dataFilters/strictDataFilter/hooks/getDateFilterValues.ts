...
export default function getDateFilterValues(props:UseDateFilterValuesProps):any[] {
  const { slice } = props
  return slice === StateSlices.CARTO ? handleCartoFilters(props) : handleOtherFilters(props)
}

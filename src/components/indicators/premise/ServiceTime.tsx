...
function OpeningTime({dataSource}: BasicWidgetType){
  const { widget } = useWidgetEffect(<CustomBarWidget dataSource={dataSource} {...openProps} />, [dataSource])
  return(
    <Grid item>
      {widget}
    </Grid>
...
function ClosingTime({dataSource}: BasicWidgetType){
  const { widget } = useWidgetEffect(<CustomBarWidget dataSource={dataSource} {...closeProps} />, [dataSource])
  return(
    <Grid item>
      {widget}
    </Grid>

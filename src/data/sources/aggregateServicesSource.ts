...
export const AGGREGATE_SERVICES_SOURCE_ID = SOURCE_NAMES.AGG_SERVICE_SOURCE;
const phases = {
  1: '`carto-dw-ac-4v8fnfsh.shared.kuerydesagregadoporservicios`',
  2: '`carto-dw-ac-4v8fnfsh.shared.feedback_round_2`',
};

const useAggregateSource = () => {
...
export default useAggregateSource;
